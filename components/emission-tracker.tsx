...
export default function EmissionTracker({ onSaveReading }: EmissionTrackerProps) {
  ...
  const co2FromTraditional = traditionalMiles * 404
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="glass-light p-6 animate-fade-in-up hover:glass-strong transition-all duration-300">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 glass-strong text-white focus:outline-none focus:ring-2 focus:ring-emerald-400/50 transition-all duration-300"
              />
            </div>
            ...
            <div className="glass-strong p-4 rounded-lg transition-all duration-300">
        ...
        <Card
          className="glass-light p-6 animate-fade-in-up hover:glass-strong transition-all duration-300"
          ...
          <div className="space-y-4">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 glass-strong text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 text-sm transition-all duration-300"
              />
              <Button
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto">
              {indoorPlants.length === 0 ? (
                ...
                indoorPlants.map((plant, idx) => (
                  <div
                    key={plant.id}
                    className="flex items-center justify-between glass-strong p-3 rounded-lg transition-all duration-300 animate-fade-in hover:bg-white/20"
                  ...
                  >
                    ...
                    <button
                      ...
                      className="text-xs px-2 py-1 bg-red-500/20 text-red-300 hover:bg-red-500/30 rounded border border-red-400/30 transition-all duration-300 backdrop-blur-md"
                    >
                      Remove
                    </button>
                  </div>
            ...
            {indoorPlants.length > 0 && (
              <div className="glass-strong p-4 rounded-lg mt-4 animate-fade-in transition-all duration-300">
                <div className="flex items-center gap-2 mb-3">
      ...
      <div className="flex justify-end animate-fade-in-up">
        <Button
          ...
          className="bg-emerald-500/30 hover:bg-emerald-500/50 text-emerald-100 border border-emerald-400/50 backdrop-blur-md px-8 transition-all duration-300"
        >
          Save All Data
        </Button>
      </div>
